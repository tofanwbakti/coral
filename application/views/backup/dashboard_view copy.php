      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"> <img class="img-fluid for-light" src="<?=base_url()?>assets/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="<?=base_url()?>assets/images/logo/logo_dark.png" alt=""></a></div>
          ...
          <div class="nav-right col-xl-8 col-lg-12 col-auto pull-right right-header p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                <svg>
                  <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Bookmark"></use>
                </svg>
              ...
              <li class="cart-nav onhover-dropdown">
                <div class="cart-box"> 
                  <svg>
                    <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Buy"></use>
                  </svg>
                </div>
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-50" src="<?=base_url()?>assets/images/ecommerce/05.jpg" alt="">
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-50" src="<?=base_url()?>assets/images/ecommerce/02.jpg" alt="">
                      ...
                      <ul>
                        ...
                        <li>
                          <div class="monthly-data"> 
                            <div class="invoice-data-icon"><span> 
                                <svg>
                                  <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Ticket-Star"></use>
                                </svg></span>
                              <div><a href="">
                        ...
                        <li>
                          <div class="monthly-data">
                            <div class="invoice-data-icon"><span>
                                <svg>
                                  <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Discovery"></use>
                                </svg></span>
                        ...
                        <li>
                          <div class="monthly-data">
                            <div class="invoice-data-icon"><span> 
                                <svg> 
                                  <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Shield-Done"></use>
                                </svg></span>
                        ...
                        <li>
                          <button class="btn btn-outline-light txt-dark active w-100" type="button"><a class="d-flex gap-2 align-items-center" href="projects.html"> 
                              <svg>
                                <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Plus-Circle"></use>
                      ...
                      <div class="dropdown">
                        <button class="btn dropdown-toggle custom-date-btn" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span>19 Aug - 25 Aug</span>
                          <div class="custom-date">
                            <svg>
                              <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Left-Arrow"></use>
                            </svg>
                            <svg>
                              <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Right-Arrow"></use>
                            </svg>
                          </div>
                        </button>
                    ...
                    <div class="recent-statistics">
                      <ul>
                        <li> 
                          <div class="arrow-up">
                            <svg>
                              <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Arrow-Up"></use>
                            </svg>
                          </div><span>$5.850</span>
                        </li>
                        <li>
                          <div class="arrow-down">
                            <svg> 
                              <use href="<?=base_url()?>assets/svg/icon-sprite.svg#Arrow-Down"></use>
                            </svg>
                          </div><span>$1.750</span>
                        </li>
                      </ul>
                  ...
                  <div class="card-body pt-0">
                    <div class="notification-card">
                      <ul>
                        ...
                        <li> 
                          <div class="user-notification">
                            <div> <img src="<?=base_url()?>assets/images/dashboard/avtar/18.jpg" alt="avatar"></div>
                            <div class="user-description"><a href="letter-box.html">
